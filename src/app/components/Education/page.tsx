      ...
      <Timeline sx={{ [`& .MuiTimelineItem-root:before`]: { flex: 0, padding: 0 } }}>
          ...
          <TimelineContent sx={{ py: "12px", px: 2 }}>
            ...
            <Box sx={{ mt: 1, ml: 3 }}>
              <ul style={{ paddingLeft: 20 }}>
                <li>Interdisciplinary research in NLP, HCI, and Computational Social Science</li>
        ...
        <TimelineItem sx={{ '&:before': { display: 'none' } }}>
          ...
          <TimelineContent sx={{ py: "12px", px: 2 }}>
            ...
            <Box sx={{ mt: 1, ml: 3 }}>
              <ul style={{ paddingLeft: 20 }}>
                <li>Participated in seminar on International Macroeconomics and Econometrics</li>
                <li>Studied Descriptive, Inferential, and Bayesian Statistics</li>
              </ul>
            </Box>
          </TimelineContent>
        </TimelineItem>
